...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  /***/
  "./src/app/login/forgot-psw/forgot-psw.component.ts": function srcAppLoginForgotPswForgotPswComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ForgotPswComponent", function () {
    ...
    var _directives_numbers_only_directive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    function ForgotPswComponent_span_18_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ForgotPswComponent_span_19_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    var ForgotPswComponent = /*#__PURE__*/function () {
      function ForgotPswComponent(apiService, fb, router) {
        _classCallCheck(this, ForgotPswComponent);
      ...
      _createClass(ForgotPswComponent, [{
        key: "ngOnInit",
        ...
        value: function submit() {
          ...
          try {
            ...
            this.apiService.forgotPsw(this.forgotForm.value.phoneNumber).subscribe(function (res) {
              if (res && typeof res === "string") {
                ...
                if (response && response.message) {
                  ...
                  _this.apiService.genericMessage(response.message, 'success');

                  _this.router.navigate(['/login']); // this.router.navigate(['/forgot-psw-response']);
              ...
              if (error.error && error.error.message) {
                _this.apiService.genericMessage(error.error.message || 'something went wrong', 'error');
              } else {
                _this.apiService.genericMessage('Did not find any student with this mobile number', 'error');
              }
    ...
    ForgotPswComponent.ɵfac = function ForgotPswComponent_Factory(t) {
      return new (t || ForgotPswComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
    };

    ForgotPswComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ForgotPswComponent,
      selectors: [["app-forgot-psw"]],
      decls: 27,
      vars: 3,
      consts: [[1, "forgot-psw"], [1, "forgot-psw__overlay", "row", "m-0"], [1, "col-md-6", "text-sm-center", "d-flex", "forgot-psw__left", "animated", "bounceInLeft"], [1, "white-color"], [1, "primary-color"], [1, "col-md-6", "d-flex", "forgot-psw__right"], [3, "formGroup", "submit"], [1, "forgot-psw__form", "card", "m-r-32", "animated", "bounceInDown"], [1, "forgot-psw__header"], [1, "forgot-psw__form-group"], ["type", "text", "numbersOnly", "", "maxlength", "10", "minlength", "10", "formControlName", "phoneNumber", "placeholder", "Enter your mobile number", 1, "form-control"], [1, "f-14", "error-message"], [4, "ngIf"], [1, "m-t-28", "text-center"], ["type", "submit", 1, "my-btn", "my-btn-primary", "w-100"], [1, "text-center", "m-t-20", "f-l", "pointer"], ["routerLink", "/login"]],
      template: function ForgotPswComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function ForgotPswComponent_Template_form_submit_9_listener() {
            return ctx.submit();
          });
        ...
        if (rf & 2) {
          var tmp_2_0 = null;
          var currVal_2 = (ctx.forgotForm.get("phoneNumber").touched || ctx.formSubmitted) && ((tmp_2_0 = ctx.forgotForm.get("phoneNumber")) == null ? null : tmp_2_0.value == null ? null : tmp_2_0.value.length) > 0 && ((tmp_2_0 = ctx.forgotForm.get("phoneNumber")) == null ? null : tmp_2_0.value == null ? null : tmp_2_0.value.length) < 10;
  ...
  "./src/app/login/login.module.ts": function srcAppLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _forgot_psw_forgot_psw_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./forgot-psw/forgot-psw.component */
    ...
    LoginModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](LoginModule, {
        declarations: [_login_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"], _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_5__["SignUpComponent"], _forgot_psw_forgot_psw_component__WEBPACK_IMPORTED_MODULE_7__["ForgotPswComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  "./src/app/login/login/login.component.ts": function srcAppLoginLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(apiService, fb, router) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          ...
          try {
            localStorage.clear();
            this.apiService.showLoader.next(true);
            this.apiService.login(this.loginForm.value).subscribe(function (response) {
              _this2.apiService.showLoader.next(false);

              if (response.status && response.status === 200) {
                var body = JSON.parse(response.body) || {};
                var role = body.roles && body.roles.assignedRoles ? body.roles.assignedRoles : '';
                var allRoles = body.roles && body.roles.allRoles && typeof body.roles.allRoles === 'string' ? JSON.parse(body.roles.allRoles || '[]') : [];
                localStorage.setItem("allRoles", JSON.stringify(allRoles));

                _this2.apiService.setAllRole(allRoles);

                localStorage.setItem("adminUser", response.body);
                localStorage.setItem("userName", body.roles.userName);
                var token = response.headers.get("auth_token");
                localStorage.setItem("auth_token", token);
                localStorage.setItem("role", role);

                _this2.apiService.setUserDetails(body);

                _this2.apiService.setToken(token);

                _this2.apiService.setRole(role);

                if (role.indexOf("STUDENT") > -1) {
                  _this2.router.navigate(["./student"]);
                } else {
              ...
              if (response && typeof response === "string") {
                ...
                if (resp && resp.message) {
                  _this2.apiService.genericMessage(resp.message, "success");
    ...
    LoginComponent.ɵfac = function LoginComponent_Factory(t) {
      return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
    };
  ...
  /***/
  "./src/app/login/sign-up/sign-up.component.ts": function srcAppLoginSignUpSignUpComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    SignUpComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 47,
      vars: 1,
      consts: [[1, "signup-page"], [1, "signup-page__overlay", "row", "m-0"], [1, "col-md-6", "text-sm-center", "d-flex", "signup-page__left", "animated", "bounceInLeft"], [1, "white-color"], [1, "primary-color"], [1, "col-md-6", "d-flex", "signup-page__right"], [3, "formGroup"], [1, "signup-page__form", "card", "m-r-32", "animated", "bounceInDown"], ["src", "/assets/images/sadisha.png"], [1, "signup-page__header"], [1, "signup-page__sub-header"], [1, "signup-page__form-group"], ["type", "text", "formControlName", "userName", "placeholder", "Enter your user name", 1, "form-control"], ["type", "email", "formControlName", "email", "placeholder", "Enter your Email ID", 1, "form-control"], ["type", "password", "formControlName", "password", "placeholder", "Enter your password", 1, "form-control"], ["type", "password", "formControlName", "confirmPassword", "placeholder", "Confirm your password", 1, "form-control"], [1, "m-t-28", "text-center"], ["type", "button", 1, "my-btn", "my-btn-primary", "w-100", 3, "click"], [1, "row", "m-t-20", "signup-page__forgot-sec", "no-gutters"], [1, "custom-control", "custom-checkbox"], ["type", "checkbox", "id", "termsAndCondition", 1, "custom-control-input"], ["for", "termsAndCondition", 1, "custom-control-label"], ["routerLink", "/terms-and-conditions"], [1, "text-center", "m-t-20", "f-l"], ["routerLink", "/"]],
