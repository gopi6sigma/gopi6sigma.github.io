...
/* harmony import */ var _api_constant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api.constant */ "./src/app/api.constant.ts");
...
class ApiService {
    constructor(httpClient, router, cookieService) {
        ...
        const attemptNumber = this.cookieService.get("attemptNumber") || 0;
    ...
    login(payload) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].LOGIN}`;
    ...
    forgotPsw(phone) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].FORGOT_PSW}?phoneNumber=${phone}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
            }),
    ...
    fetchQuestionPapers() {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].FETCH_QUESTIONS}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
            }),
    ...
    getAnswerPaper() {
        ...
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].ANSWER_PAPER}`;
    ...
    getAllAnswerPaper() {
        ...
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].ANSWER_PAPER}s`;
        return this.httpClient.get(apiUrl, {
            ...httpOptions,
            ...{ responseType: "text", observe: "response" },
        });
    }
    submitAnswerPaper(payload) {
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
    ...
    fetchQuestionsForPractice(contestId) {
        const prevAttemptNumber = this.cookieService.get("attemptNumber") || 0;
        ...
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].QUESTIONS}/${studentId}/${contestId}/${this.nextAttemptNumber}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
            }),
    ...
    fetchPapersBasedOnStatus(status) {
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
        ...
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].ANSWER_PAPERS_BY_STATUS}${status}`;
        return this.httpClient.get(apiUrl, httpOptions);
    }
    fetchPapersBasedOnUser(user) {
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
        ...
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].ANSWER_PAPERS_BY_STATUS_BY_USER}${user}`;
        return this.httpClient.get(apiUrl, httpOptions);
    }
    deletePapers(url, status) {
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
        ...
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].ANSWER_PAPER}?imageUrl=${url}&pendingStatus=${status}`;
        return this.httpClient.delete(apiUrl, httpOptions);
    }
    submitAnswers(payload, contestId) {
        const studentId = this.cookieService.get("studentId");
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].SUBMIT}/${studentId}/${contestId}/${this.nextAttemptNumber}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
            }),
    ...
    getListOfSchools() {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].SCHOOLS}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
            }),
    ...
    getListOfExamCenters() {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].EXAM_CENTERS}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
            }),
    ...
    getRandomStudent() {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].GET_STUDENT}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
    ...
    getAllStudents() {
        ...
        return this.httpClient.get(`${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].STUDENTS}`, httpOptions);
    }
    getStudentsStats() {
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
        ...
        return this.httpClient.get(`${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].STUDENTS_STATS}`, httpOptions);
    }
    getAllUsers() {
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
        ...
        return this.httpClient.get(`${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].USERS}`, httpOptions);
    }
    getFinalResults() {
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
        ...
        return this.httpClient.get(`${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].RESULTS_SYNC}`, httpOptions);
    }
    updateUserRoles(userId, payload) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].USERS}?userName=${userId}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
    ...
    getStudentDetails(studentId) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].GET_STUDENT}/${studentId}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
    ...
    computeStats() {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].COMPUTE_STATS}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token
    ...
    deleteStudent(userName) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].GET_STUDENT}/?userName=${userName}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
    ...
    clearStudentAns(userName) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].ANSWERS_BY_USER}${userName}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
    ...
    studentRegistration(payload) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].STUDENTS}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
            }),
    ...
    // Gallery
    addStudentImage(payload, id) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].UPLOAD_PHOTO}/${id}`;
    ...
    addPaperImage(payload) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].UPLOAD_PAPER}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
    ...
    registerVolunteer(payload) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].REGISTER_VOLUNTEER}`;
    ...
    computeFinalResults(payload) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].COMPUTE_FINAL_RESULTS}`;
    ...
    getZones() {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].ZONES}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
    ...
    // Gallery
    addGallery(payload, endUrl) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].GALLERY}/${endUrl}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                // "Content-Type": "application/x-www-form-urlencoded",
                auth_token: this.token,
    ...
    getGalleryImages(mediaType) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].GALLERY}/${mediaType}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
    ...
    getAllGalleryImages(mediaType) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].GALLERY_EDIT}/${mediaType}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "Content-Type": "application/json",
                auth_token: this.token,
    ...
    updateGalleryAssetStatus(payload, endUrl) {
        const apiUrl = `${this.baseUrl}/${_api_constant__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].GALLERY}?mediaUrl=${endUrl}`;
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                // "Content-Type": "application/x-www-form-urlencoded",
                auth_token: this.token,
...
/* harmony import */ var _style_guide_style_guide_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style-guide/style-guide.component */ "./src/app/style-guide/style-guide.component.ts");
/* harmony import */ var _login_terms_and_conditions_terms_and_conditions_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./login/terms-and-conditions/terms-and-conditions.component */ "./src/app/login/terms-and-conditions/terms-and-conditions.component.ts");
/* harmony import */ var _login_forgot_psw_forgot_psw_response_forgot_psw_response_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./login/forgot-psw/forgot-psw-response/forgot-psw-response.component */ "./src/app/login/forgot-psw/forgot-psw-response/forgot-psw-response.component.ts");
...
const routes = [
    ...
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | website-website-module */ "website-website-module").then(__webpack_require__.bind(null, /*! ./website/website.module */ "./src/app/website/website.module.ts")).then(m => m.WebsiteModule)
    },
    {
        path: 'style-guide',
...
AppRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AppRoutingModule_Factory(t) { return new (t || AppRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forRoot(routes, { initialNavigation: 'enabled' })],
...
/* harmony import */ var _seo_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./seo.service */ "./src/app/seo.service.ts");
/* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-cookie-service */ "./node_modules/ngx-cookie-service/__ivy_ngcc__/fesm2015/ngx-cookie-service.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _shared_snack_bar_snack_bar_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/snack-bar/snack-bar.component */ "./src/app/shared/snack-bar/snack-bar.component.ts");
...
function AppComponent_app_snack_bar_1_Template(rf, ctx) { if (rf & 1) {
...
class AppComponent {
    constructor(apiService, _seoService, router, activatedRoute, cookieService) {
    ...
    ngOnInit() {
        this.apiService.showLoader.subscribe((flag) => {
            if (this.showLoader !== flag) {
                this.showLoader = flag;
            }
        });
        this.apiService.internalNotifier.subscribe((data) => {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 3, vars: 2, consts: [[3, "data", 4, "ngIf"], ["class", "app-loading", 4, "ngIf"], [3, "data"], [1, "app-loading"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterOutlet"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], _shared_snack_bar_snack_bar_component__WEBPACK_IMPORTED_MODULE_7__["CommonAlertSnackComponent"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2FwcC5jb21wb25lbnQuc2NzcyJ9 */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
    ...
    }], function () { return [{ type: _api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }, { type: _seo_service__WEBPACK_IMPORTED_MODULE_4__["SEOService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }, { type: ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__["CookieService"] }]; }, null); })();
...
/* harmony import */ var ng2_animate_on_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng2-animate-on-scroll */ "./node_modules/ng2-animate-on-scroll/__ivy_ngcc__/fesm2015/ng2-animate-on-scroll.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _style_guide_style_guide_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style-guide/style-guide.component */ "./src/app/style-guide/style-guide.component.ts");
...
/* harmony import */ var _can_active_router_guard_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./can-active-router-guard.service */ "./src/app/can-active-router-guard.service.ts");
/* harmony import */ var _login_terms_and_conditions_terms_and_conditions_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./login/terms-and-conditions/terms-and-conditions.component */ "./src/app/login/terms-and-conditions/terms-and-conditions.component.ts");
/* harmony import */ var _login_forgot_psw_forgot_psw_response_forgot_psw_response_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./login/forgot-psw/forgot-psw-response/forgot-psw-response.component */ "./src/app/login/forgot-psw/forgot-psw-response/forgot-psw-response.component.ts");
...
/* harmony import */ var _seo_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./seo.service */ "./src/app/seo.service.ts");
/* harmony import */ var ngx_webcam__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ngx-webcam */ "./node_modules/ngx-webcam/__ivy_ngcc__/fesm2015/ngx-webcam.js");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_api_service__WEBPACK_IMPORTED_MODULE_12__["ApiService"], _can_active_router_guard_service__WEBPACK_IMPORTED_MODULE_14__["CanActiveRouterGuardService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_17__["CookieService"], _seo_service__WEBPACK_IMPORTED_MODULE_19__["SEOService"]], imports: [[
            ...
            ng2_animate_on_scroll__WEBPACK_IMPORTED_MODULE_4__["AnimateOnScrollModule"].forRoot(),
            ...
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_18__["NgbCarouselModule"],
        ],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        _style_guide_style_guide_component__WEBPACK_IMPORTED_MODULE_6__["StyleGuideComponent"],
        _login_terms_and_conditions_terms_and_conditions_component__WEBPACK_IMPORTED_MODULE_15__["TermsAndConditionsComponent"],
        _login_forgot_psw_forgot_psw_response_forgot_psw_response_component__WEBPACK_IMPORTED_MODULE_16__["ForgotPswResponseComponent"]], imports: [ngx_webcam__WEBPACK_IMPORTED_MODULE_20__["WebcamModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"],
        _layout_layout_module__WEBPACK_IMPORTED_MODULE_7__["LayoutModule"], ng2_animate_on_scroll__WEBPACK_IMPORTED_MODULE_4__["AnimateOnScrollModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], _angular_service_worker__WEBPACK_IMPORTED_MODULE_9__["ServiceWorkerModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_13__["HttpClientModule"],
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_18__["NgbModule"],
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_18__["NgbCarouselModule"]], exports: [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _style_guide_style_guide_component__WEBPACK_IMPORTED_MODULE_6__["StyleGuideComponent"],
                    _login_terms_and_conditions_terms_and_conditions_component__WEBPACK_IMPORTED_MODULE_15__["TermsAndConditionsComponent"],
                    _login_forgot_psw_forgot_psw_response_forgot_psw_response_component__WEBPACK_IMPORTED_MODULE_16__["ForgotPswResponseComponent"],
                ],
                imports: [
                    ngx_webcam__WEBPACK_IMPORTED_MODULE_20__["WebcamModule"],
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"].withServerTransition({
...
/*!****************************************************!*\
  !*** ./src/app/can-active-router-guard.service.ts ***!
  \****************************************************/
/*! exports provided: CanActiveRouterGuardService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CanActiveRouterGuardService", function() { return CanActiveRouterGuardService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api.service */ "./src/app/api.service.ts");



class CanActiveRouterGuardService {
...
CanActiveRouterGuardService.ɵfac = function CanActiveRouterGuardService_Factory(t) { return new (t || CanActiveRouterGuardService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"])); };
CanActiveRouterGuardService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: CanActiveRouterGuardService, factory: CanActiveRouterGuardService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CanActiveRouterGuardService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
DragAndDropDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({ type: DragAndDropDirective, selectors: [["", "appDragAndDrop", ""]], hostVars: 4, hostBindings: function DragAndDropDirective_HostBindings(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DragAndDropDirective, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
                selector: '[appDragAndDrop]'
            }]
    }], function () { return []; }, { onFileDropped: [{
...
/*!*******************************************************!*\
  !*** ./src/app/directives/event-tracker.directive.ts ***!
  \*******************************************************/
/*! exports provided: EventTrackerDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventTrackerDirective", function() { return EventTrackerDirective; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
EventTrackerDirective.ɵfac = function EventTrackerDirective_Factory(t) { return new (t || EventTrackerDirective)(); };
EventTrackerDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({ type: EventTrackerDirective, selectors: [["", "appEventTracker", ""]], hostBindings: function EventTrackerDirective_HostBindings(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventTrackerDirective_click_HostBindingHandler($event) { return ctx.onClick($event); });
    } }, inputs: { option: ["eventTracker", "option"] } });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventTrackerDirective, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
...
/*!***************************************************************************!*\
  !*** ./src/app/layout/address-nav-header/address-nav-header.component.ts ***!
  \***************************************************************************/
/*! exports provided: AddressNavHeaderComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddressNavHeaderComponent", function() { return AddressNavHeaderComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


class AddressNavHeaderComponent {
    constructor() { }
    ngOnInit() {
    }
}
AddressNavHeaderComponent.ɵfac = function AddressNavHeaderComponent_Factory(t) { return new (t || AddressNavHeaderComponent)(); };
AddressNavHeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AddressNavHeaderComponent, selectors: [["app-address-nav-header"]], decls: 18, vars: 0, consts: [[1, "d-flex", "address-nav", "justify-content-end", "flex-wrap", "container-fluid"], [1, "address-nav__list"], [1, "address-nav__item"], ["href", "mailto:admin@sadisha.org", 1, "address-nav__link"], ["href", "tel:+91-9550895968", 1, "address-nav__link", "text-nowrap"], ["href", "https://www.facebook.com/sadisha.org/", 1, "address-nav__link", "social-icon"], [1, "mdi", "mdi-facebook-box"], [1, "mdi", "mdi-twitter-box"], [1, "mdi", "mdi-instagram"]], template: function AddressNavHeaderComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddressNavHeaderComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
function AdminHeaderComponent_li_8_Template(rf, ctx) { if (rf & 1) {
...
const _c0 = function () { return ["../paper-upload"]; };
const _c1 = function () { return ["../evaluation"]; };
const _c2 = function () { return ["../student-edit"]; };
const _c3 = function () { return ["../gallery-upload"]; };
const _c4 = function () { return ["../status"]; };
...
AdminLandingComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AdminLandingComponent, selectors: [["app-admin-landing"]], decls: 53, vars: 10, consts: [[1, "contrainer-fluid", "feature"], [1, "text-center", "f-22", "m-t-32", "m-b-20", "font-italic", "primary-text"], [1, "row", "align-items-center"], [1, "col-12", "col-md-4", "text-center"], [1, "feature__wrapper", "border", "p-5", "d-block", 3, "routerLink"], [1, "feature__icon", "mb-3"], ["src", "/assets/icons/mobile.svg", "alt", ""], [1, "feature__header", "mb-3"], [1, "feature__description"], ["src", "/assets/icons/admin.svg", "alt", ""], ["src", "/assets/icons/gallery.svg", "alt", ""], ["src", "/assets/icons/student-stots.svg", "alt", ""]], template: function AdminLandingComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/*!*********************************************************************************!*\
  !*** ./src/app/layout/compute-final-results/compute-final-results.component.ts ***!
  \*********************************************************************************/
/*! exports provided: ComputeFinalResultsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ComputeFinalResultsComponent", function() { return ComputeFinalResultsComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
function ComputeFinalResultsComponent_tr_14_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ComputeFinalResultsComponent_tr_14_Template_input_ngModelChange_4_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const zone_r1 = ctx.$implicit; const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.config[zone_r1.id].open = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "td");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "input", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ComputeFinalResultsComponent_tr_14_Template_input_ngModelChange_6_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const zone_r1 = ctx.$implicit; const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.config[zone_r1.id].zphs = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "td");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "input", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ComputeFinalResultsComponent_tr_14_Template_input_ngModelChange_8_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const zone_r1 = ctx.$implicit; const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.config[zone_r1.id].girls = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
class ComputeFinalResultsComponent {
    constructor(apiService) {
        this.apiService = apiService;
        this.zones = [];
        this.config = {};
    ...
    loadZones() {
        this.apiService.getZones().subscribe((res) => {
            console.log(res);
            this.zones = res;
    ...
    saveConfiguration() {
        const payload = this.zones.map(zone => {
            ...
            return ({
                zone: zone.zoneName,
                open: ((_a = this.config[zone.id]) === null || _a === void 0 ? void 0 : _a.open) || 0,
                zphs: ((_b = this.config[zone.id]) === null || _b === void 0 ? void 0 : _b.zphs) || 0,
                girls: ((_c = this.config[zone.id]) === null || _c === void 0 ? void 0 : _c.girls) || 0
            });
        });
        console.log(payload);
        this.apiService.computeFinalResults(payload).subscribe((res) => {
            if (res === 'Done') {
...
ComputeFinalResultsComponent.ɵfac = function ComputeFinalResultsComponent_Factory(t) { return new (t || ComputeFinalResultsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"])); };
ComputeFinalResultsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ComputeFinalResultsComponent, selectors: [["app-compute-final-results"]], decls: 17, vars: 1, consts: [[4, "ngFor", "ngForOf"], [3, "click"], ["type", "number", "min", "0", 3, "ngModel", "ngModelChange"]], template: function ComputeFinalResultsComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ComputeFinalResultsComponent_Template_button_click_15_listener() { return ctx.saveConfiguration(); });
...
FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FooterComponent, selectors: [["app-footer"]], decls: 29, vars: 0, consts: [[1, "p-12", "footer"], [1, "container"], [1, "row", "justify-content-between", "align-items-center"], [1, "col-sm-4", "align-self-center", "align-centre"], ["href", "http://sadisha.org/", 1, "navbar-brand", "logo"], ["src", "assets/images/sadisha.png", "alt", "Logo", 1, "img-fluid", "logo-img"], [1, "text-white"], ["href", "mailto:admin@sadisha.org", 1, "theme-color"], ["href", "tel:+919550895968", 1, "theme-color"], [1, "address-nav"], [1, "address-nav__list"], [1, "address-nav__item"], ["href", "https://www.facebook.com/sadisha.org/", 1, "address-nav__link", "social-icon"], [1, "mdi", "mdi-facebook-box"], [1, "mdi", "mdi-twitter-box"], [1, "mdi", "mdi-instagram"], [1, "text-white", "ml-3"]], template: function FooterComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/api.service */ "./src/app/api.service.ts");
/* harmony import */ var _address_nav_header_address_nav_header_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../address-nav-header/address-nav-header.component */ "./src/app/layout/address-nav-header/address-nav-header.component.ts");
...
const _c1 = function () { return ["/student-registration"]; };
const _c2 = function () { return ["/volunteer-registration"]; };
const _c3 = function () { return ["/faq"]; };
const _c4 = function () { return ["/talent-test"]; };
const _c5 = function () { return ["/gallery"]; };
const _c6 = function () { return ["/press"]; };
...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 40, vars: 24, consts: [[1, "navbar", "navbar-expand-lg", "navbar-light", "header", "container-fluid", "main-navbar"], ["type", "button", "aria-controls", "menuDropdown", "aria-label", "Toggle navigation", 1, "navbar-toggler", 3, "click"], [1, "navbar-toggler-icon"], ["href", "http://sadisha.org/", 1, "navbar-brand", "logo"], ["src", "assets/images/sadisha.png", "alt", "Logo", 1, "img-fluid", "logo-img"], ["id", "menuDropdown", 1, "collapse", "navbar-collapse", "justify-content-end"], [1, "navbar-nav", "mr-auto", "mt-2", "mt-lg-0"], ["routerLinkActive", "active", 1, "nav-item", "px-12", "mx-4"], [1, "nav-link", 3, "routerLink", "click"], ["routerLinkActive", "active", 1, "nav-item", "dropdown", "px-12", "mx-4"], ["href", "#", "role", "button", 1, "nav-link", "dropdown-toggle", 3, "click"], [1, "dropdown-menu"], [1, "dropdown-item", 3, "routerLink", "click"], [1, "dropdown-divider"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_button_click_3_listener($event) { return ctx.toggleMenu($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_11_listener($event) { return ctx.toggleMenu($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](12, " Home ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](13, "li", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](14, "a", 10);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_14_listener($event) { return ctx.toggleRegisterDropdown($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](15, " REGISTER ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](16, "div", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](17, "a", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_17_listener($event) { return ctx.toggleRegisterDropdown($event); })("click", function HeaderComponent_Template_a_click_17_listener($event) { return ctx.toggleMenu($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_20_listener($event) { return ctx.toggleRegisterDropdown($event); })("click", function HeaderComponent_Template_a_click_20_listener($event) { return ctx.toggleMenu($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_23_listener($event) { return ctx.toggleMenu($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_26_listener($event) { return ctx.toggleMenu($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_29_listener($event) { return ctx.toggleMenu($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_32_listener($event) { return ctx.toggleMenu($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_35_listener($event) { return ctx.toggleMenu($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_Template_a_click_38_listener($event) { return ctx.toggleMenu($event); });
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/api.service */ "./src/app/api.service.ts");
/* harmony import */ var _admin_header_admin_header_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../admin-header/admin-header.component */ "./src/app/layout/admin-header/admin-header.component.ts");
/* harmony import */ var _side_nav_side_nav_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../side-nav/side-nav.component */ "./src/app/layout/side-nav/side-nav.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
LayoutWrapperComponent.ɵfac = function LayoutWrapperComponent_Factory(t) { return new (t || LayoutWrapperComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"])); };
LayoutWrapperComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LayoutWrapperComponent, selectors: [["app-layout-wrapper"]], decls: 7, vars: 0, consts: [[1, "content-wrapper", "position-relative", "d-md-flex"], [1, "app-sidebar"], [1, "app-content", "w-100"], [1, "p-16", "router-content"]], template: function LayoutWrapperComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } }, directives: [_admin_header_admin_header_component__WEBPACK_IMPORTED_MODULE_2__["AdminHeaderComponent"], _side_nav_side_nav_component__WEBPACK_IMPORTED_MODULE_3__["SideNavComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterOutlet"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2xheW91dC9sYXlvdXQtd3JhcHBlci9sYXlvdXQtd3JhcHBlci5jb21wb25lbnQuc2NzcyJ9 */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LayoutWrapperComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _side_nav_side_nav_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./side-nav/side-nav.component */ "./src/app/layout/side-nav/side-nav.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../shared/shared.module */ "./src/app/shared/shared.module.ts");
/* harmony import */ var _layout_wrapper_layout_wrapper_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./layout-wrapper/layout-wrapper.component */ "./src/app/layout/layout-wrapper/layout-wrapper.component.ts");
/* harmony import */ var _admin_header_admin_header_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./admin-header/admin-header.component */ "./src/app/layout/admin-header/admin-header.component.ts");
/* harmony import */ var _admin_landing_admin_landing_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./admin-landing/admin-landing.component */ "./src/app/layout/admin-landing/admin-landing.component.ts");
/* harmony import */ var _student_edit_student_edit_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./student-edit/student-edit.component */ "./src/app/layout/student-edit/student-edit.component.ts");
/* harmony import */ var _student_modal_student_modal_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./student-modal/student-modal.component */ "./src/app/layout/student-modal/student-modal.component.ts");
/* harmony import */ var _role_management_role_management_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./role-management/role-management.component */ "./src/app/layout/role-management/role-management.component.ts");
/* harmony import */ var _user_management_user_management_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./user-management/user-management.component */ "./src/app/layout/user-management/user-management.component.ts");
/* harmony import */ var _student_stats_student_stats_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./student-stats/student-stats.component */ "./src/app/layout/student-stats/student-stats.component.ts");
/* harmony import */ var _compute_final_results_compute_final_results_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./compute-final-results/compute-final-results.component */ "./src/app/layout/compute-final-results/compute-final-results.component.ts");
...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'paper-upload',
                loadChildren: () => Promise.all(/*! import() | paper-upload-paper-upload-module */[__webpack_require__.e("common"), __webpack_require__.e("paper-upload-paper-upload-module")]).then(__webpack_require__.bind(null, /*! ../paper-upload/paper-upload.module */ "./src/app/paper-upload/paper-upload.module.ts")).then((m) => m.PaperUploadModule),
            },
            {
                path: 'evaluation',
                loadChildren: () => __webpack_require__.e(/*! import() | evaluation-evaluation-module */ "evaluation-evaluation-module").then(__webpack_require__.bind(null, /*! ../evaluation/evaluation.module */ "./src/app/evaluation/evaluation.module.ts")).then((m) => m.EvaluationModule),
            },
            {
                path: 'papers',
                loadChildren: () => __webpack_require__.e(/*! import() | papers-papers-module */ "papers-papers-module").then(__webpack_require__.bind(null, /*! ../papers/papers.module */ "./src/app/papers/papers.module.ts")).then((m) => m.PapersModule),
            },
            {
                path: 'features',
                loadChildren: () => Promise.all(/*! import() | image-upload-image-upload-module */[__webpack_require__.e("common"), __webpack_require__.e("image-upload-image-upload-module")]).then(__webpack_require__.bind(null, /*! ../image-upload/image-upload.module */ "./src/app/image-upload/image-upload.module.ts")).then((m) => m.ImageUploadModule),
            },
            {
                path: 'gallery-upload',
                loadChildren: () => Promise.all(/*! import() | image-upload-image-upload-module */[__webpack_require__.e("common"), __webpack_require__.e("image-upload-image-upload-module")]).then(__webpack_require__.bind(null, /*! ../image-upload/image-upload.module */ "./src/app/image-upload/image-upload.module.ts")).then((m) => m.ImageUploadModule),
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](LayoutModule, { declarations: [_side_nav_side_nav_component__WEBPACK_IMPORTED_MODULE_2__["SideNavComponent"],
        _layout_wrapper_layout_wrapper_component__WEBPACK_IMPORTED_MODULE_6__["LayoutWrapperComponent"],
        _admin_header_admin_header_component__WEBPACK_IMPORTED_MODULE_7__["AdminHeaderComponent"],
        _admin_landing_admin_landing_component__WEBPACK_IMPORTED_MODULE_8__["AdminLandingComponent"],
        _student_edit_student_edit_component__WEBPACK_IMPORTED_MODULE_9__["StudentEditComponent"],
        _student_modal_student_modal_component__WEBPACK_IMPORTED_MODULE_10__["StudentModalComponent"],
        _role_management_role_management_component__WEBPACK_IMPORTED_MODULE_11__["RoleManagementComponent"],
        _user_management_user_management_component__WEBPACK_IMPORTED_MODULE_12__["UserManagementComponent"],
        _student_stats_student_stats_component__WEBPACK_IMPORTED_MODULE_13__["StudentStatsComponent"],
        _compute_final_results_compute_final_results_component__WEBPACK_IMPORTED_MODULE_14__["ComputeFinalResultsComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"],
        _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"]], exports: [_side_nav_side_nav_component__WEBPACK_IMPORTED_MODULE_2__["SideNavComponent"], _admin_header_admin_header_component__WEBPACK_IMPORTED_MODULE_7__["AdminHeaderComponent"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LayoutModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _user_management_user_management_component__WEBPACK_IMPORTED_MODULE_12__["UserManagementComponent"],
                    _student_stats_student_stats_component__WEBPACK_IMPORTED_MODULE_13__["StudentStatsComponent"],
                    _compute_final_results_compute_final_results_component__WEBPACK_IMPORTED_MODULE_14__["ComputeFinalResultsComponent"],
                ],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _student_modal_student_modal_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../student-modal/student-modal.component */ "./src/app/layout/student-modal/student-modal.component.ts");
...
function RoleManagementComponent_tr_15_td_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function RoleManagementComponent_tr_15_td_3_Template_input_change_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); const j_r8 = ctx.index; const i_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().index; const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.checkValue(i_r5, j_r8); })("ngModelChange", function RoleManagementComponent_tr_15_td_3_Template_input_ngModelChange_3_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11); const j_r8 = ctx.index; const name_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; return (name_r4.access[j_r8] = $event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    const name_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
...
function RoleManagementComponent_tr_15_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RoleManagementComponent_tr_15_Template_td_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); const i_r5 = ctx.index; const ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r15.selectStudent(i_r5); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class RoleManagementComponent {
    ...
    selectStudent(index) {
        let dailogRef = this.dialog.open(_student_modal_student_modal_component__WEBPACK_IMPORTED_MODULE_1__["StudentModalComponent"], {
            panelClass: "col-md-6",
            hasBackdrop: true,
            disableClose: true,
...
RoleManagementComponent.ɵfac = function RoleManagementComponent_Factory(t) { return new (t || RoleManagementComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"])); };
RoleManagementComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RoleManagementComponent, selectors: [["app-role-management"]], decls: 19, vars: 2, consts: [[1, "container-fluid"], [1, "row"], [1, "col-md-12", "animated", "rotateInUpLeft"], [1, "card", "w-100", "m-auto"], [1, "text-center"], [1, "card-body"], [1, "table-responsive"], [1, "table", "text-center"], [1, "table-dark"], [4, "ngFor", "ngForOf"], [3, "ngClass", 4, "ngFor", "ngForOf"], [1, "card-footer", "text-right"], [1, "my-btn", 3, "click"], [3, "ngClass"], [1, "hover", 3, "click"], [1, "toggleSwitch", "nolabel"], ["type", "checkbox", "name", "role", 3, "ngModel", "change", "ngModelChange"]], template: function RoleManagementComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RoleManagementComponent_Template_button_click_17_listener() { return ctx.update(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RoleManagementComponent, [{
    ...
    }], function () { return [{ type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }]; }, null); })();
...
function SideNavComponent_li_2_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const nav_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
class SideNavComponent {
    ...
    ngOnInit() {
        ...
        this.apiService.sideNavOpened.subscribe((flag) => {
...
SideNavComponent.ɵfac = function SideNavComponent_Factory(t) { return new (t || SideNavComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"])); };
SideNavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SideNavComponent, selectors: [["app-side-nav"]], decls: 3, vars: 1, consts: [[1, "side-nav"], ["routerLinkActive", "active", 4, "ngFor", "ngForOf"], ["routerLinkActive", "active"], [3, "routerLink", 4, "ngIf"], [3, "routerLink", "queryParams", 4, "ngIf"], [3, "routerLink"], [3, "routerLink", "queryParams"]], template: function SideNavComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/* harmony import */ var _student_modal_student_modal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../student-modal/student-modal.component */ "./src/app/layout/student-modal/student-modal.component.ts");
...
/* harmony import */ var _directives_numbers_only_directive__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../directives/numbers-only.directive */ "./src/app/directives/numbers-only.directive.ts");
...
function StudentEditComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "form", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function StudentEditComponent_div_4_Template_form_submit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.getStudentDetails(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function StudentEditComponent_div_4_Template_input_ngModelChange_10_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.studentId = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function StudentEditComponent_div_5_div_13_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Student Name ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_div_20_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Parent Name ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_div_27_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Select Gender ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_div_34_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Select Zone");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_div_41_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Select Mandal/Taluk");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_div_48_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Select School");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_span_56_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Contact Number ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_span_57_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Valid Contact Number ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_span_65_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Contact Number ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_span_66_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Valid Contact Number ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_span_69_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Update");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_span_70_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Updating...");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentEditComponent_div_5_Template(rf, ctx) { if (rf & 1) {
    const _r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "form", 18);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function StudentEditComponent_div_5_Template_form_submit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21); const ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r20.updateStudent(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function StudentEditComponent_div_5_Template_ng_select_change_33_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21); const ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r22.onSelectDistrict(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function StudentEditComponent_div_5_Template_ng_select_change_40_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21); const ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r23.onSelectMandal(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentEditComponent_div_5_Template_button_click_71_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21); const ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r24.resetForm(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentEditComponent_div_5_Template_button_click_73_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21); const ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](8); return ctx_r25.deleteStudent(_r3); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentEditComponent_div_5_Template_button_click_76_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21); const ctx_r26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](8); return ctx_r26.clearAnswers(_r3); });
    ...
    const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    var tmp_16_0 = null;
    const currVal_16 = (ctx_r1.studentsForm.get("contactNumber").touched || ctx_r1.formSubmitted) && ((tmp_16_0 = ctx_r1.studentsForm.get("contactNumber")) == null ? null : tmp_16_0.value == null ? null : tmp_16_0.value.length) > 0 && ((tmp_16_0 = ctx_r1.studentsForm.get("contactNumber")) == null ? null : tmp_16_0.value == null ? null : tmp_16_0.value.length) < 10;
    var tmp_18_0 = null;
    const currVal_18 = (ctx_r1.studentsForm.get("secondaryContact").touched || ctx_r1.formSubmitted) && ((tmp_18_0 = ctx_r1.studentsForm.get("secondaryContact")) == null ? null : tmp_18_0.value == null ? null : tmp_18_0.value.length) > 0 && ((tmp_18_0 = ctx_r1.studentsForm.get("secondaryContact")) == null ? null : tmp_18_0.value == null ? null : tmp_18_0.value.length) < 10;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
const _c0 = function (a0) { return { selected: a0 }; };
function StudentEditComponent_div_6_tr_24_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentEditComponent_div_6_tr_24_Template_td_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r31); const i_r29 = ctx.index; const ctx_r30 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r30.selectStudent(i_r29); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "td");
...
function StudentEditComponent_div_6_Template(rf, ctx) { if (rf & 1) {
...
function StudentEditComponent_ng_template_7_Template(rf, ctx) { if (rf & 1) {
    const _r37 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 46);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "button", 47);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentEditComponent_ng_template_7_Template_button_click_1_listener() { const d_r33 = ctx.dismiss; return d_r33("Cross click"); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentEditComponent_ng_template_7_Template_button_click_12_listener() { const d_r33 = ctx.dismiss; return d_r33("Cross click"); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, " \u00A0 \u00A0 Cancel \u00A0 \u00A0");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](14, "\u00A0 \u00A0 ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "button", 55);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentEditComponent_ng_template_7_Template_button_click_15_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r37); const ctx_r36 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r36.delete(); });
...
class StudentEditComponent {
    constructor(apiService, fb, dialog, modalService, config, router, activatedRoute) {
        this.apiService = apiService;
        this.fb = fb;
        this.dialog = dialog;
    ...
    confirmDelete() {
        ...
        this.apiService.deleteStudent(this.studentId).subscribe((res) => {
    ...
    confirmClearAns() {
        this.apiService.showLoader.next(true);
        this.apiService.clearStudentAns(this.studentId).subscribe((res) => {
            this.apiService.showLoader.next(false);
    ...
    getStudentDetails() {
        this.apiService.showLoader.next(true);
        try {
            this.apiService.getStudentDetails(this.studentId).subscribe((res) => {
                this.apiService.showLoader.next(false);
    ...
    selectStudent(index) {
        let dailogRef = this.dialog.open(_student_modal_student_modal_component__WEBPACK_IMPORTED_MODULE_2__["StudentModalComponent"], {
            panelClass: "col-md-6",
            hasBackdrop: true,
            disableClose: true,
            data: { studentData: this.hardCodeData, district: this.districtsList },
    ...
    getAllSchools() {
        try {
            this.apiService.showLoader.next(true);
            this.apiService.getListOfSchools().subscribe((res) => {
                this.apiService.showLoader.next(false);
    ...
    getRandomStudent() {
        try {
            this.apiService.showLoader.next(true);
            this.apiService.getRandomStudent().subscribe((res) => {
                this.apiService.showLoader.next(false);
                if (res) {
                    this.showStudentDetails(res);
                    // this.formatDistrictsData(res);
    ...
    updateStudent() {
        ...
        const payload = { ...this.studentsForm.value };
        ...
        try {
            this.apiService.showLoader.next(true);
            this.apiService.updateStudent(payload, this.studentId).subscribe((res) => {
                if (res) {
                    this.showForm = false;
                    this.newStudent = res;
                }
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StudentEditComponent, [{
    ...
    }], function () { return [{ type: src_app_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"] }, { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModal"] }, { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModalConfig"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"] }]; }, null); })();
...
/* harmony import */ var _directives_numbers_only_directive__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../directives/numbers-only.directive */ "./src/app/directives/numbers-only.directive.ts");
...
function StudentModalComponent_div_5_div_9_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Student Name ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_div_16_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Parent Name ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_div_23_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Select Class ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_div_30_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Select Gender ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_div_37_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Select District ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_div_44_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Select Mandal ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_div_51_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Select School ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_span_59_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Contact Number ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_span_60_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Please Enter Valid Contact Number ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_span_63_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Update");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_span_64_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Updating...");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function StudentModalComponent_div_5_Template(rf, ctx) { if (rf & 1) {
    const _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 5);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "form", 6);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function StudentModalComponent_div_5_Template_form_submit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13); const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r12.updateStudent(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function StudentModalComponent_div_5_Template_ng_select_change_36_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13); const ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r14.onSelectDistrict(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function StudentModalComponent_div_5_Template_ng_select_change_43_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13); const ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r15.onSelectMandal(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StudentModalComponent_div_5_Template_button_click_65_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13); const ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r16.resetForm(); });
    ...
    const ctx_r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    var tmp_19_0 = null;
    const currVal_19 = (ctx_r0.studentsForm.get("contactNumber").touched || ctx_r0.formSubmitted) && ((tmp_19_0 = ctx_r0.studentsForm.get("contactNumber")) == null ? null : tmp_19_0.value == null ? null : tmp_19_0.value.length) > 0 && ((tmp_19_0 = ctx_r0.studentsForm.get("contactNumber")) == null ? null : tmp_19_0.value == null ? null : tmp_19_0.value.length) < 10;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
/*!*****************************************************************!*\
  !*** ./src/app/layout/student-stats/student-stats.component.ts ***!
  \*****************************************************************/
/*! exports provided: StudentStatsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StudentStatsComponent", function() { return StudentStatsComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/api.service */ "./src/app/api.service.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
...
function StudentStatsComponent_tr_13_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "td");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function StudentStatsComponent_div_14_tr_11_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "td");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function StudentStatsComponent_div_14_Template(rf, ctx) { if (rf & 1) {
...
class StudentStatsComponent {
    ...
    getStudentsStats() {
        try {
            this.apiService.showLoader.next(true);
            this.apiService.getStudentsStats().subscribe((res) => {
                this.apiService.showLoader.next(false);
                console.log(res);
                if (res && Object.keys(res)) {
                    this.formatDistrictsData(res);
...
StudentStatsComponent.ɵfac = function StudentStatsComponent_Factory(t) { return new (t || StudentStatsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"])); };
StudentStatsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: StudentStatsComponent, selectors: [["app-student-stats"]], decls: 15, vars: 2, consts: [[1, "page"], [1, "page-header", "f-22", "m-t-5", "m-b-20", "font-italic"], [1, "page-content"], [1, "table-responsive"], [1, "table", "text-center"], [1, "table-dark"], [4, "ngFor", "ngForOf"], ["class", "table-responsive", 4, "ngFor", "ngForOf"], [1, "text-center"]], template: function StudentStatsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h1", 1);
...
function UserManagementComponent_tr_15_td_3_span_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const role_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function UserManagementComponent_tr_15_td_3_div_2_Template(rf, ctx) { if (rf & 1) {
    const _r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "input", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function UserManagementComponent_tr_15_td_3_div_2_Template_input_ngModelChange_2_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16); const role_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; const user_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; return (user_r3.assignedRoles[role_r8] = $event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    const role_r8 = ctx_r19.$implicit;
    const j_r9 = ctx_r19.index;
    const ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    const user_r3 = ctx_r18.$implicit;
    const i_r4 = ctx_r18.index;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
function UserManagementComponent_tr_15_td_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td");
...
function UserManagementComponent_tr_15_img_6_Template(rf, ctx) { if (rf & 1) {
    const _r23 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "img", 17);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserManagementComponent_tr_15_img_6_Template_img_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r23); const i_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().index; const ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r21.editUserRoles(i_r4); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function UserManagementComponent_tr_15_button_7_Template(rf, ctx) { if (rf & 1) {
    const _r26 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 18);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserManagementComponent_tr_15_button_7_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r26); const ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); const i_r4 = ctx_r25.index; const user_r3 = ctx_r25.$implicit; const ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r24.updateRoles(i_r4, user_r3); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Update");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
...
class UserManagementComponent {
    ...
    updateRoles(index, user) {
        try {
            ...
            this.apiService.showLoader.next(true);
            this.apiService.updateUserRoles(user.userName, { roles: roles.join(',') }).subscribe((res) => {
                this.apiService.showLoader.next(false);
                console.log('res:', res);
...
UserManagementComponent.ɵfac = function UserManagementComponent_Factory(t) { return new (t || UserManagementComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"])); };
UserManagementComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UserManagementComponent, selectors: [["app-user-management"]], decls: 16, vars: 6, consts: [[1, "page"], [1, "page-header", "f-22", "m-t-5", "m-b-20", "font-italic"], [1, "page-content"], [1, "table-responsive"], [1, "table", "text-center"], [1, "table-dark"], [4, "ngFor", "ngForOf"], ["class", "edit-icon-img", "src", "assets/icons/edit-ico.svg", "alt", "edit", 3, "click", 4, "ngIf"], ["class", "btn btn-small btn-primary", 3, "click", 4, "ngIf"], [4, "ngIf"], ["class", "roles__toggle-wrapper", 4, "ngIf"], [1, "roles__toggle-wrapper"], [1, "onoffswitch", "onoffswitch--yes-or-no", "roles__toggle-switch"], ["type", "checkbox", "name", "onoffswitch", 1, "onoffswitch-checkbox", 3, "ngModel", "ngModelOptions", "id", "checked", "ngModelChange"], [1, "onoffswitch-label", 3, "for"], [1, "onoffswitch-inner"], [1, "onoffswitch-switch"], ["src", "assets/icons/edit-ico.svg", "alt", "edit", 1, "edit-icon-img", 3, "click"], [1, "btn", "btn-small", "btn-primary", 3, "click"]], template: function UserManagementComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h1", 1);
...
/*!***************************************************************************************!*\
  !*** ./src/app/login/forgot-psw/forgot-psw-response/forgot-psw-response.component.ts ***!
  \***************************************************************************************/
/*! exports provided: ForgotPswResponseComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ForgotPswResponseComponent", function() { return ForgotPswResponseComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _forgot_psw_response_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./forgot-psw-response.component.scss */ "./src/app/login/forgot-psw/forgot-psw-response/forgot-psw-response.component.scss");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
...
function ForgotPswResponseComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
class ForgotPswResponseComponent {
    constructor(route) {
        this.route = route;
    }
    ngOnInit() {
...
ForgotPswResponseComponent.ɵfac = function ForgotPswResponseComponent_Factory(t) { return new (t || ForgotPswResponseComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"])); };
ForgotPswResponseComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ForgotPswResponseComponent, selectors: [["app-forgot-psw-response"]], decls: 13, vars: 1, consts: [[1, "container"], [1, "row"], [1, "col-md-12"], [1, "response-container"], [4, "ngIf"], [1, "welcome_title", "text-center", "m-t-32", "animated", "bounceInLeft"], ["routerLink", "/login", 1, "pointer"], [1, "response-message"], [1, "credentials"], [1, "credential"], [1, "credential-label"], [1, "credential-value"]], template: function ForgotPswResponseComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterLinkWithHref"]], styles: [".response-container[_ngcontent-%COMP%] {\n  background-color: #f9f9f9;\n  padding: 20px;\n  border-radius: 10px;\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n  margin-top: 20px;\n}\n\nh1[_ngcontent-%COMP%] {\n  font-size: 24px;\n  margin-bottom: 10px;\n}\n\n.response-message[_ngcontent-%COMP%] {\n  margin-top: 20px;\n  padding: 20px;\n  background-color: #fff;\n  border-radius: 5px;\n  box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);\n}\n\n.credentials[_ngcontent-%COMP%] {\n  margin-top: 20px;\n}\n\n.credential[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  margin-bottom: 10px;\n}\n.credential-label[_ngcontent-%COMP%] {\n  font-weight: bold;\n  color: #6e63ff;\n  margin-right: 10px;\n}\n.credential-value[_ngcontent-%COMP%] {\n  flex-grow: 1;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ForgotPswResponseComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
TermsAndConditionsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TermsAndConditionsComponent, selectors: [["app-terms-and-conditions"]], decls: 5, vars: 0, consts: [[1, "row", "no-gutters", "p-l-20", "p-t-20"], [1, "animated", "bounceInLeft"], ["routerLink", "/signup"]], template: function TermsAndConditionsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
...
/*!****************************************!*\
  !*** ./src/app/pipes/titleCaseWord.ts ***!
  \****************************************/
/*! exports provided: TitleCaseWord */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TitleCaseWord", function() { return TitleCaseWord; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
TitleCaseWord.ɵfac = function TitleCaseWord_Factory(t) { return new (t || TitleCaseWord)(); };
TitleCaseWord.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({ name: "titleCaseWord", type: TitleCaseWord, pure: true });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TitleCaseWord, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
        args: [{ name: 'titleCaseWord' }]
    }], function () { return []; }, null); })();
...
function AccordionItemComponent_span_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "span", 3);
} }
function AccordionItemComponent_span_4_Template(rf, ctx) { if (rf & 1) {
...
AccordionItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AccordionItemComponent, selectors: [["accordion-item"]], outputs: { toggleEmitter: "toggleEmitter" }, ngContentSelectors: _c2, decls: 7, vars: 6, consts: [[1, "d-flex", "justify-content-between", "m-0", 3, "ngClass", "click"], ["class", "mdi mdi-plus-circle", 4, "ngIf"], ["class", "mdi mdi-minus-circle", 4, "ngIf"], [1, "mdi", "mdi-plus-circle"], [1, "mdi", "mdi-minus-circle"]], template: function AccordionItemComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵprojectionDef"](_c0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "header", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AccordionItemComponent_Template_header_click_0_listener() { return ctx.onToggle(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("@toggle", ctx.expanded);
            ...
            Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('toggle', [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('true', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ height: '*' })),
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('false', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ height: '0px' })),
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AccordionItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
/*!*********************************************************!*\
  !*** ./src/app/shared/accordion/accordion.component.ts ***!
  \*********************************************************/
/*! exports provided: AccordionMode, AccordionComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccordionMode", function() { return AccordionMode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccordionComponent", function() { return AccordionComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _accordion_item_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./accordion-item.component */ "./src/app/shared/accordion/accordion-item.component.ts");
...
AccordionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AccordionComponent, selectors: [["accordion"]], contentQueries: function AccordionComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, inputs: { mode: "mode" }, ngContentSelectors: _c0, decls: 1, vars: 0, template: function AccordionComponent_Template(rf, ctx) { if (rf & 1) {
...
/*!***********************************************************************************************!*\
  !*** ./src/app/shared/common-delete-warning-dialog/common-delete-warning-dialog.component.ts ***!
  \***********************************************************************************************/
/*! exports provided: CommonDeleteWarningDialogComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CommonDeleteWarningDialogComponent", function() { return CommonDeleteWarningDialogComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _pipes_safeHtml_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../pipes/safeHtml.pipe */ "./src/app/pipes/safeHtml.pipe.ts");





class CommonDeleteWarningDialogComponent {
...
CommonDeleteWarningDialogComponent.ɵfac = function CommonDeleteWarningDialogComponent_Factory(t) { return new (t || CommonDeleteWarningDialogComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"])); };
CommonDeleteWarningDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CommonDeleteWarningDialogComponent, selectors: [["app-common-delete-warning-dialog"]], decls: 8, vars: 3, consts: [[1, "m-40"], [1, "m-b-40", "f-18", "line-height-31", "text-grey2", "f-w-400", 3, "innerHtml"], [1, "d-flex", "justify-content-center"], ["type", "button", 1, "my-btn", "cancel-btn", 3, "click"], ["type", "button", 1, "my-btn", "my-btn-primary", "m-l-28", 3, "click"]], template: function CommonDeleteWarningDialogComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommonDeleteWarningDialogComponent_Template_button_click_4_listener() { return ctx.closePopup("cancel"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Cancel");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "button", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommonDeleteWarningDialogComponent_Template_button_click_6_listener() { return ctx.closePopup("confirm"); });
...
HeroImageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeroImageComponent, selectors: [["app-hero-image"]], inputs: { heading: "heading", bgImageClass: "bgImageClass" }, decls: 4, vars: 2, consts: [[1, "hero-wrapper", 3, "ngClass"], [1, "animated", "bounceInLeft"]], template: function HeroImageComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h1", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3);
...
/*!***********************************************************!*\
  !*** ./src/app/shared/logo-brand/logo-brand.component.ts ***!
  \***********************************************************/
/*! exports provided: LogoBrandComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogoBrandComponent", function() { return LogoBrandComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


class LogoBrandComponent {
    constructor() { }
    ngOnInit() {
    }
}
LogoBrandComponent.ɵfac = function LogoBrandComponent_Factory(t) { return new (t || LogoBrandComponent)(); };
LogoBrandComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LogoBrandComponent, selectors: [["app-logo-brand"]], decls: 5, vars: 0, consts: [[1, "navbar-brand", "brand"], [1, "brand__primary"], [1, "brand__secondary"]], template: function LogoBrandComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LogoBrandComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
PageNotFoundComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PageNotFoundComponent, selectors: [["app-page-not-found"]], decls: 8, vars: 0, consts: [[1, "page-not-found", "d-flex", "justify-content-center", "align-items-center"], [1, ""], ["src", "/assets/images/page_not_found.svg", "alt", "Page not found", 1, "page-not-found__img", "animated", "bounceInDown"], [1, "welcome_title", "text-center", "m-t-32", "animated", "bounceInLeft"], [1, "pointer"]], template: function PageNotFoundComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
...
ServerDownComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ServerDownComponent, selectors: [["app-server-down"]], decls: 5, vars: 0, consts: [[1, "server-down", "d-flex", "justify-content-center", "align-items-center"], [1, ""], ["src", "/assets/images/server_down.svg", "alt", "Page not found", 1, "server-down__img", "animated", "bounceInDown"], [1, "welcome_title", "text-center", "m-t-32", "animated", "bounceInLeft"]], template: function ServerDownComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](2, "img", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "h1", 3);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ServerDownComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _logo_brand_logo_brand_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./logo-brand/logo-brand.component */ "./src/app/shared/logo-brand/logo-brand.component.ts");
/* harmony import */ var _welcome_welcome_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./welcome/welcome.component */ "./src/app/shared/welcome/welcome.component.ts");
/* harmony import */ var _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./page-not-found/page-not-found.component */ "./src/app/shared/page-not-found/page-not-found.component.ts");
/* harmony import */ var _server_down_server_down_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./server-down/server-down.component */ "./src/app/shared/server-down/server-down.component.ts");
...
/* harmony import */ var _common_delete_warning_dialog_common_delete_warning_dialog_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./common-delete-warning-dialog/common-delete-warning-dialog.component */ "./src/app/shared/common-delete-warning-dialog/common-delete-warning-dialog.component.ts");
/* harmony import */ var _pipes_safeHtml_pipe__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../pipes/safeHtml.pipe */ "./src/app/pipes/safeHtml.pipe.ts");
/* harmony import */ var _snack_bar_snack_bar_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./snack-bar/snack-bar.component */ "./src/app/shared/snack-bar/snack-bar.component.ts");
/* harmony import */ var angular_highcharts__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! angular-highcharts */ "./node_modules/angular-highcharts/__ivy_ngcc__/fesm2015/angular-highcharts.js");
...
/* harmony import */ var _pipes_titleCaseWord__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../pipes/titleCaseWord */ "./src/app/pipes/titleCaseWord.ts");
...
/* harmony import */ var _hero_image_hero_image_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./hero-image/hero-image.component */ "./src/app/shared/hero-image/hero-image.component.ts");
/* harmony import */ var _layout_address_nav_header_address_nav_header_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../layout/address-nav-header/address-nav-header.component */ "./src/app/layout/address-nav-header/address-nav-header.component.ts");
/* harmony import */ var _accordion_accordion_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./accordion/accordion.component */ "./src/app/shared/accordion/accordion.component.ts");
/* harmony import */ var _accordion_accordion_item_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./accordion/accordion-item.component */ "./src/app/shared/accordion/accordion-item.component.ts");
/* harmony import */ var ng_lazyload_image__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ng-lazyload-image */ "./node_modules/ng-lazyload-image/__ivy_ngcc__/fesm2015/ng-lazyload-image.js");
/* harmony import */ var _directives_event_tracker_directive__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../directives/event-tracker.directive */ "./src/app/directives/event-tracker.directive.ts");
/* harmony import */ var _slider_link_slider_link_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./slider-link/slider-link.component */ "./src/app/shared/slider-link/slider-link.component.ts");
/* harmony import */ var _directives_numbers_only_directive__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../directives/numbers-only.directive */ "./src/app/directives/numbers-only.directive.ts");
/* harmony import */ var _directives_drag_and_drop_directive__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../directives/drag-and-drop.directive */ "./src/app/directives/drag-and-drop.directive.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SharedModule, { declarations: [_logo_brand_logo_brand_component__WEBPACK_IMPORTED_MODULE_2__["LogoBrandComponent"],
        ...
        _server_down_server_down_component__WEBPACK_IMPORTED_MODULE_5__["ServerDownComponent"],
        _common_delete_warning_dialog_common_delete_warning_dialog_component__WEBPACK_IMPORTED_MODULE_10__["CommonDeleteWarningDialogComponent"],
        _pipes_safeHtml_pipe__WEBPACK_IMPORTED_MODULE_11__["SafeHtmlPipe"],
        _pipes_titleCaseWord__WEBPACK_IMPORTED_MODULE_15__["TitleCaseWord"],
        _snack_bar_snack_bar_component__WEBPACK_IMPORTED_MODULE_12__["CommonAlertSnackComponent"],
        ...
        _hero_image_hero_image_component__WEBPACK_IMPORTED_MODULE_19__["HeroImageComponent"],
        _layout_address_nav_header_address_nav_header_component__WEBPACK_IMPORTED_MODULE_20__["AddressNavHeaderComponent"],
        _accordion_accordion_component__WEBPACK_IMPORTED_MODULE_21__["AccordionComponent"],
        _accordion_accordion_item_component__WEBPACK_IMPORTED_MODULE_22__["AccordionItemComponent"],
        _directives_event_tracker_directive__WEBPACK_IMPORTED_MODULE_24__["EventTrackerDirective"],
        _slider_link_slider_link_component__WEBPACK_IMPORTED_MODULE_25__["SliderLinkComponent"],
        _directives_numbers_only_directive__WEBPACK_IMPORTED_MODULE_26__["NumberDirective"],
        _directives_drag_and_drop_directive__WEBPACK_IMPORTED_MODULE_27__["DragAndDropDirective"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_6__["NgSelectModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"],
        _angular_material_tabs__WEBPACK_IMPORTED_MODULE_8__["MatTabsModule"],
        _angular_material_dialog__WEBPACK_IMPORTED_MODULE_9__["MatDialogModule"],
        angular_highcharts__WEBPACK_IMPORTED_MODULE_13__["ChartModule"],
        ngx_pagination__WEBPACK_IMPORTED_MODULE_14__["NgxPaginationModule"], _angular_router__WEBPACK_IMPORTED_MODULE_18__["RouterModule"]], exports: [_logo_brand_logo_brand_component__WEBPACK_IMPORTED_MODULE_2__["LogoBrandComponent"],
        _welcome_welcome_component__WEBPACK_IMPORTED_MODULE_3__["WelcomeComponent"],
        _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_4__["PageNotFoundComponent"],
        _server_down_server_down_component__WEBPACK_IMPORTED_MODULE_5__["ServerDownComponent"],
        _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_6__["NgSelectModule"],
        ...
        _slider_link_slider_link_component__WEBPACK_IMPORTED_MODULE_25__["SliderLinkComponent"],
        _directives_numbers_only_directive__WEBPACK_IMPORTED_MODULE_26__["NumberDirective"],
        _directives_drag_and_drop_directive__WEBPACK_IMPORTED_MODULE_27__["DragAndDropDirective"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SharedModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
                declarations: [
                    _logo_brand_logo_brand_component__WEBPACK_IMPORTED_MODULE_2__["LogoBrandComponent"],
                    _welcome_welcome_component__WEBPACK_IMPORTED_MODULE_3__["WelcomeComponent"],
                    _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_4__["PageNotFoundComponent"],
                    _server_down_server_down_component__WEBPACK_IMPORTED_MODULE_5__["ServerDownComponent"],
                    _common_delete_warning_dialog_common_delete_warning_dialog_component__WEBPACK_IMPORTED_MODULE_10__["CommonDeleteWarningDialogComponent"],
...
/*!*************************************************************!*\
  !*** ./src/app/shared/slider-link/slider-link.component.ts ***!
  \*************************************************************/
/*! exports provided: SliderLinkComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SliderLinkComponent", function() { return SliderLinkComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
...
SliderLinkComponent.ɵfac = function SliderLinkComponent_Factory(t) { return new (t || SliderLinkComponent)(); };
SliderLinkComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SliderLinkComponent, selectors: [["app-slider-link"]], inputs: { text: "text", link: "link" }, decls: 4, vars: 3, consts: [[1, "slider"], [1, "p-0", "m-0", "text-nowrap"], [1, "text-white", "pointer", "link", 3, "routerLink"]], template: function SliderLinkComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/*!*********************************************************!*\
  !*** ./src/app/shared/snack-bar/snack-bar.component.ts ***!
  \*********************************************************/
/*! exports provided: CommonAlertSnackComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CommonAlertSnackComponent", function() { return CommonAlertSnackComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/api.service */ "./src/app/api.service.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
...
const _c0 = ["containerBox"];
function CommonAlertSnackComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommonAlertSnackComponent_div_2_Template_span_click_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.closeAlert(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function CommonAlertSnackComponent_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "span", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommonAlertSnackComponent_div_3_Template_span_click_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.closeAlert(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function CommonAlertSnackComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "span", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommonAlertSnackComponent_div_4_Template_span_click_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.closeAlert(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function CommonAlertSnackComponent_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "span", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CommonAlertSnackComponent_div_5_Template_span_click_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r11.closeAlert(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
class CommonAlertSnackComponent {
    constructor(apiService, render) {
        this.apiService = apiService;
        this.render = render;
    }
...
CommonAlertSnackComponent.ɵfac = function CommonAlertSnackComponent_Factory(t) { return new (t || CommonAlertSnackComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"])); };
CommonAlertSnackComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CommonAlertSnackComponent, selectors: [["app-snack-bar"]], viewQuery: function CommonAlertSnackComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { processData: ["data", "processData"] }, decls: 6, vars: 4, consts: [[1, "box-postion", "shadow", "alert-box"], ["containerBox", ""], ["class", "row app-msg-cont no-gutters info-msg-box", 4, "ngIf"], ["class", "row app-msg-cont no-gutters warning-msg-box", 4, "ngIf"], ["class", "row app-msg-cont no-gutters error-msg-box", 4, "ngIf"], ["class", "row app-msg-cont no-gutters success-msg-box", 4, "ngIf"], [1, "row", "app-msg-cont", "no-gutters", "info-msg-box"], [1, "col-sm"], [1, "dodger-blue-txt", "f-14", 3, "innerHtml"], [1, "col-sm-auto"], [1, "close-red-icon", "icon", "m-l-16", 3, "click"], [1, "row", "app-msg-cont", "no-gutters", "warning-msg-box"], [1, "medium-yellow-txt", "f-14", 3, "innerHtml"], [1, "row", "app-msg-cont", "no-gutters", "error-msg-box"], [1, "error-col-txt", "f-14", 3, "innerHtml"], [1, "row", "app-msg-cont", "no-gutters", "success-msg-box"], [1, "green-txt", "f-14", 3, "innerHtml"]], template: function CommonAlertSnackComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CommonAlertSnackComponent, [{
    ...
    }], function () { return [{ type: src_app_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"] }]; }, { containerRef: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: ['containerBox', { static: true }]
        }], processData: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"],
            args: ['data']
        }] }); })();
...
WelcomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: WelcomeComponent, selectors: [["app-welcome"]], decls: 8, vars: 0, consts: [[1, "welcome", "d-flex", "justify-content-center", "align-items-center"], [1, ""], ["src", "/assets/images/welcome.svg", "alt", "welcome to Med360", 1, "welcome__img", "animated", "bounceInDown"], [1, "welcome_title", "text-center", "m-t-32", "animated", "bounceInLeft"], [1, "primary-color"]], template: function WelcomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](2, "img", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "h1", 3);
...
/*!******************************************************!*\
  !*** ./src/app/style-guide/style-guide.component.ts ***!
  \******************************************************/
/*! exports provided: StyleGuideComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StyleGuideComponent", function() { return StyleGuideComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
function StyleGuideComponent_tr_72_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "td");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
StyleGuideComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: StyleGuideComponent, selectors: [["app-style-guide"]], decls: 76, vars: 6, consts: [[1, "content-wrapper"], [1, "section__wrapper", "p-25"], ["label", "Form"], [1, "section__heading"], [1, "form-group"], ["for", "exampleFormControlInput1", 1, "label"], [1, "required-star"], ["type", "email", "id", "exampleFormControlInput1", "placeholder", "name@example.com", 1, "form-control"], ["for", "exampleFormControlSelect1", 1, "label"], ["placeholder", "select language", "name", "selectedLanguage", 3, "items", "ngModel", "ngModelChange"], ["for", "exampleFormControlSelect2", 1, "label"], ["placeholder", "select language", "name", "selectedLanguage", 3, "items", "ngModel", "multiple", "ngModelChange"], ["for", "exampleFormControlTextarea1", 1, "label"], ["id", "exampleFormControlTextarea1", "rows", "3", 1, "form-control"], [1, "custom-control", "custom-checkbox"], ["type", "checkbox", "id", "keepMeSignIn", 1, "custom-control-input"], ["for", "keepMeSignIn", 1, "custom-control-label", "pointer", "label"], [1, "form-group", "m-t-12"], [1, "custom-control", "custom-radio", "custom-control-inline"], ["type", "radio", "id", "customRadioInline1", "name", "customRadioInline1", 1, "custom-control-input"], ["for", "customRadioInline1", 1, "custom-control-label", "label"], ["type", "radio", "id", "customRadioInline2", "name", "customRadioInline1", 1, "custom-control-input"], ["for", "customRadioInline2", 1, "custom-control-label", "label"], [1, "m-t-28"], ["type", "button", 1, "my-btn", "my-btn-primary"], ["type", "button", 1, "my-btn", "cancel-btn", "m-l-28"], ["label", "Tabs"], [1, "responsive-table"], [1, "table", "table-striped", "table-hover", "my-table"], [4, "ngFor", "ngForOf"], ["label", "Modals"], [1, "py-1"], ["src", "/assets/images/avatar.png", "alt", "avatar"]], template: function StyleGuideComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function StyleGuideComponent_Template_ng_select_ngModelChange_19_listener($event) { return ctx.selectedLanguage = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function StyleGuideComponent_Template_ng_select_ngModelChange_25_listener($event) { return ctx.selectedLanguage = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StyleGuideComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
module.exports = __webpack_require__(/*! /Users/sravanibalne/Documents/sadisha/mtt-ui/src/main.ts */"./src/main.ts");
